...
<div>
    <img src="assets/lcd.jpg" width="500">
</div>

Real-time output generated by the STM32F446 application using FreeRTOS.  
Data shown includes temperature & humidity (SHT31), ambient light (TSL2591),  
pressure (BME280), and accelerometer/gyroscope data (MPU6050).  
