...
#define __LL_I2C_10BIT_HEADER_READ(__ADDRESS__)                         ((uint8_t)((uint16_t)((uint16_t)(((uint16_t)((__ADDRESS__) & (uint16_t)(0x0300))) >> 7) | (uint16_t)(0xF1))))
	...
	__STATIC_INLINE void LL_I2C_ConfigFilters(I2C_TypeDef *I2Cx,
			uint32_t AnalogFilter, uint32_t DigitalFilter) {
		MODIFY_REG(I2Cx->FLTR, I2C_FLTR_ANOFF | I2C_FLTR_DNF,
	...
	__STATIC_INLINE void LL_I2C_SetOwnAddress1(I2C_TypeDef *I2Cx,
			uint32_t OwnAddress1, uint32_t OwnAddrSize) {
		MODIFY_REG(I2Cx->OAR1,
				I2C_OAR1_ADD0 | I2C_OAR1_ADD1_7 | I2C_OAR1_ADD8_9 | I2C_OAR1_ADDMODE,
	...
	__STATIC_INLINE void LL_I2C_SetPeriphClock(I2C_TypeDef *I2Cx,
		...
		MODIFY_REG(I2Cx->CR2, I2C_CR2_FREQ,
	...
	__STATIC_INLINE uint32_t LL_I2C_GetPeriphClock(I2C_TypeDef *I2Cx) {
		return (uint32_t) (__LL_I2C_FREQ_MHZ_TO_HZ(
				READ_BIT(I2Cx->CR2, I2C_CR2_FREQ)));
	}
	...
	__STATIC_INLINE void LL_I2C_ConfigSpeed(I2C_TypeDef *I2Cx,
			uint32_t PeriphClock, uint32_t ClockSpeed, uint32_t DutyCycle) {
		...
		MODIFY_REG(I2Cx->TRISE, I2C_TRISE_TRISE,
				__LL_I2C_RISE_TIME(freqrange, ClockSpeed));

		/* Configure Speed mode, Duty Cycle and Clock control register value */
		if (ClockSpeed > LL_I2C_MAX_SPEED_STANDARD) {
			/* Set Speed mode at fast and duty cycle for Clock Speed request in fast clock range */
			clockconfig = LL_I2C_CLOCK_SPEED_FAST_MODE
					| __LL_I2C_SPEED_FAST_TO_CCR(PeriphClock, ClockSpeed,
							DutyCycle) | DutyCycle;
		} else {
		...
		MODIFY_REG(I2Cx->CCR, (I2C_CCR_FS | I2C_CCR_DUTY | I2C_CCR_CCR),
				clockconfig);
	}
	...
	__STATIC_INLINE void LL_I2C_SetMode(I2C_TypeDef *I2Cx,
		...
		MODIFY_REG(I2Cx->CR1, I2C_CR1_SMBUS | I2C_CR1_SMBTYPE | I2C_CR1_ENARP,
				PeripheralMode);
	}
	...
	__STATIC_INLINE uint32_t LL_I2C_GetMode(I2C_TypeDef *I2Cx) {
		return (uint32_t) (READ_BIT(I2Cx->CR1,
				I2C_CR1_SMBUS | I2C_CR1_SMBTYPE | I2C_CR1_ENARP));
	}
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_I2C_IsActiveSMBusFlag_SMBDEFAULT(
			I2C_TypeDef *I2Cx) {
